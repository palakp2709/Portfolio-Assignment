...
const Project = () => {
  return (
    <div className="m-2 p-2">
      <h1 className="py-2 text-center  text-xl  text-[#b6eb3bcb] font-mono font-bold">
        Latest Projects <span className="font-sans">✈</span>
      </h1>
      <p className="text-center text-[0.7rem]  md:text-[0.8rem] text-[#f89090cb] ">
      ...
      <div className=" grid md:grid-cols-6 mt-10 ">
        <div className=" p-2 mx-auto md:col-span-3 duration-75 hover:scale-105 w-96 shadow-lg shadow-gray-500 md:pl-11 lg:pl-8">
          <Link to={"https://youtube-react-application.netlify.app"}>
            <img
              src={youtube}
              className=" mt-2 rounded-md w-96 md:w-72 lg:w-80"
              alt="logo"
            />
          </Link>
          <div className="pt-5 ">
            <h1 className="text-md text-[#f4fcffcb] font-mono font-bold">
              Youtube-React-Application
            </h1>
            <ul className="text-[0.7rem] py-2 lg:text-xs text-[#c4c7c9cb]  w-80">
              <li>
              ...
              >
                <li className="text-white text-[0.9rem] mt-2">
                  GitHub Link :{" "}
        ...
        <div className=" p-2 mt-10 md:mt-0 mx-auto md:col-span-3 duration-75 hover:scale-105 w-96 shadow-lg shadow-gray-500 md:pl-11 lg:pl-8">
          ...
          <div className="pt-5">
            ...
            <ul className="text-[0.7rem] lg:text-xs py-2  text-[#c4c7c9cb] w-80">
        ...
        <div className=" p-2 mt-10  m-4 mx-auto md:col-span-3 duration-75 hover:scale-105 w-96 shadow-lg shadow-gray-500 md:pl-11 lg:pl-8">
        ...
        <div className="p-2 mt-10  m-4 mx-auto md:col-span-3 duration-75 hover:scale-105 w-96 shadow-lg shadow-gray-500 md:pl-11 lg:pl-8">
          <Link to={"https://weatherwitz-react-app.netlify.app"}>
            <img
              src={weather}
              className="mt-2 rounded-md w-96 md:w-72 h-32 md:h-[8rem] lg:h-36 lg:w-80"
              alt="logo"
            />
          </Link>
          <div className="pt-5">
