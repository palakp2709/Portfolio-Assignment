  ...
  return (
    <div className="h-screen w-full bg-[#0a192f] " id="contact">
      <div className="max-w-[800px] flex flex-col  h-full justify-center mx-auto p-2">
        <div>
          <h1 className="text-4xl font-bold border-b-4 border-pink-600 inline  text-[#ccd6f6]">
            Contact Me 🛫
          </h1>
        ...
        >
          ...
          <button
            className=" border mt-4 mx-auto py-2 sm:py-3 px-6  hover:bg-pink-600 hover:border-pink-600 w-28 "
            type="submit"
          >
            Submit
          </button>
